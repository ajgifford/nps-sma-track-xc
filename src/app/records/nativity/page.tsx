import recordsData from '@/../../data/records_nativity.json';
...
export default function NativityRecords() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-8 text-gray-900">Nativity School Records</h1>
